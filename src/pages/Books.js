    ...
    <div>
      ...
      >
        ...
        <div>
          ...
          <p>
            <span className="font-bold">Author:</span> {books[bookid].author}
          </p>
        </div>
        ...
        <ul className="mb-4">
          ...
          <li>
            <span className="font-bold">Pages:</span> {books[bookid].pages}
          </li>
          <li>
            <span className="font-bold">ISBN:</span> {books[bookid].isbn}
          </li>
          <li>
            <span className="font-bold">Release Date:</span>{" "}
            {books[bookid].releaseDate}
          </li>
          <li>
            <a
              href={books[bookid].website}
              target="_blank"
              rel="noreferrer"
              className="font-bold"
            >
